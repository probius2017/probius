...
<h1 class="page-header"><i class="fa fa-plus"></i> Locaux <small> Ajout d'un nouveau local</small></h1>

{{ Form::open(array('url' => URL::route('locauxInf25RI.store'), 'method' => 'post')) }}
    ...
    <fieldset>
        ...
        <div class="col-md-5 col-md-offset-1 info-important">
            <legend><i class="fa fa-info-circle" aria-hidden="true"></i> Choix du/des type(s) de structure(s)</legend>
            <div class="row">
                <div class="form-group {!! $errors->has('type_structure') ? 'has-error' : '' !!} has-feedback">

                    @forelse($structures->chunk(10) as $chunk)
                    <div class="col-md-6">
                        <table id="cat-table">
                            @forelse($chunk as $structure)
                            <tr>
            ...
            <div class="row">
                <div class="col-md-12">
                    <p><b>Si local spécifique, veuillez renseigner ces deux champs :</b></p>
                </div>

                <div class="col-md-7">
                    <div class="form-group {!! $errors->has('type_structure') ? 'has-error' : '' !!} has-feedback">
                    {!! Form::label('local_spe', 'Nom de la structure', array('class' => 'control_label')) !!}
                    {!! Form::text('local_spe', false, ['class' => 'form-control']) !!}
                    </div>
                </div>

                <div class="col-md-5">
                    <div class="form-group {!! $errors->has('type_structure') ? 'has-error' : '' !!} has-feedback">
                    {!! Form::label('RI', 'RI', array('class' => 'control_label')) !!}
                    {{ Form::select('RI', ['<= 25RI', '>= 50RI'], old('$structure->RI'),  ['class' => 'form-control']) }}
                    </div>
                </div>
