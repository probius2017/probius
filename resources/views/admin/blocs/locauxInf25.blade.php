...
<div class="row">
    ...
    <div id="eraseFiltre" class="col-md-2 form-group">
        <a href="{{ route('locauxInf25RI.index') }}" class="btn btn-extia">Effacer <i class="fa fa-eraser" aria-hidden="true"></i></a>
    </div>
</div>
	...
	<table id="locauxInf25" class="table table-striped table-hover locauxDestAll">
	    ...
	    <tbody>
	        ...
	        <tr>
	            ...
	            <td>
	                <a class="btn btn-extia question-badge edition-badge" href="{{ route('locauxInf25RI.edit', $local->local_id)}}" value="" ><i class="fa fa-pencil-square-o"></i></a>
                    <a href="" class="btn btn-extia delete-data" data-url="{!! route('locauxInf25RI.destroy', $local->local_id) !!}" data-toggle="modal" data-target="#supLocal""><i class="fa fa-trash-o" aria-hidden="true"></i></a>
	            </td>
	        </tr>
            @empty
	        @endforelse
...
<div class="modal fade" id="myModalColumn" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    ...
    <form action="{{ route('updateColumns') }}" method="POST">
	{{csrf_field()}}
