...
{{ Form::open(array('url' => $local->id ? URL::route('locauxInf25RI.update', $local->id) : URL::route('locauxInf25RI.store'), 'method' => $local->id ? 'put' : 'post')) }}
    ...
    <fieldset>
        ...
        <div class="col-md-6">
            <div class="form-group {!! $errors->has('type_document') ? 'has-error' : '' !!} has-feedback">
                ...
                {!! Form::text('type_document', $bail->type_document, ['class' => 'form-control', 'aria-describedby' => 'error-updt']) !!}
    ...
    <div class="footer pull-right">
        <a href="{{ route('locauxInf25RI.index') }}" class="btn btn-default ">Annuler</a>
