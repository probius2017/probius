...
class SinistresMasseController extends Controller
{
    public function dataSinistreMasse(){
    ...
    {
        $data = (new SinistresMasseController)->dataSinistreMasse();
    ...
    public function update(SinistresRequest $request, $p, $ps, $id)
    {
        ...
        return redirect()
                ->route('listeSinistresMasse.index', [$page, $pageSmall])
